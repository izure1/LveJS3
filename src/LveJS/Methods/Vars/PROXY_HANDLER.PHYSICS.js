...
handler.__getter.x = function (p, t) {
  return this.__system__.physics.body ? this.__system__.physics.body.GetLinearVelocity().get_x() : null
}

handler.__getter.y = function (p, t) {
  return this.__system__.physics.body ? this.__system__.physics.body.GetLinearVelocity().get_y() : null
}

handler.__getter.a = function (p, t) {
  return this.__system__.physics.body ? this.__system__.physics.body.GetAngularVelocity() : null
}
