...
/***/ "./src/LveJS/Functions/checkMobile.js":
/*!********************************************!*\
  !*** ./src/LveJS/Functions/checkMobile.js ***!
  \********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = init;\n\nvar _domReady = __webpack_require__(/*! ../Utils/domReady */ \"./src/LveJS/Utils/domReady.js\");\n\nvar _domReady2 = _interopRequireDefault(_domReady);\n\nvar _calcValue = __webpack_require__(/*! ../Helpers/calcValue */ \"./src/LveJS/Helpers/calcValue.js\");\n\nvar _calcValue2 = _interopRequireDefault(_calcValue);\n\nvar _LveJSMouseEvent = __webpack_require__(/*! ../LveJSMouseEvent */ \"./src/LveJS/LveJSMouseEvent.js\");\n\nvar _LveJSMouseEvent2 = _interopRequireDefault(_LveJSMouseEvent);\n\nvar _eventEmiter = __webpack_require__(/*! ../Helpers/eventEmiter */ \"./src/LveJS/Helpers/eventEmiter.js\");\n\nvar _eventEmiter2 = _interopRequireDefault(_eventEmiter);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction init(o) {\n  var _this = this;\n\n  var c = void 0;\n\n  _domReady2.default.call(document, function () {\n\n    _this.renderer.init(o);\n\n    if (o.canvas) {\n\n      if (typeof o.canvas === 'string') c = document.querySelector(o.canvas);\n      if (o.canvas instanceof HTMLCanvasElement) {\n        c = o.canvas;\n      }\n\n      _this.renderer.setting.canvas = {};\n      _this.renderer.setting.canvas.context = c.getContext('2d');\n      _this.renderer.setting.canvas.element = c;\n      _this.renderer.start();\n    }\n\n    if (!_this.cache.inited) {\n\n      var t = void 0;\n      var i = void 0;\n\n      i = _this.renderer.setting.frameLimit || 1;\n      i = 1000 / i;\n\n      // 모바일 마우스 이벤트\n      // 이는 PC의 MouseEvent와 동급으로 취급됩니다.\n      c.addEventListener('touchstart', function (e) {\n        t = new _LveJSMouseEvent2.default('mousedown', e);\n        (0, _eventEmiter2.default)(t);\n      });\n      c.addEventListener('touchend', function (e) {\n        t = new _LveJSMouseEvent2.default('mouseup', e);\n        (0, _eventEmiter2.default)(t);\n      });\n      c.addEventListener('touchmove', function (e) {\n        _this.suppressJob.setSuppress('touchmoveEvent', function () {\n          t = new _LveJSMouseEvent2.default('mousemove', e);\n          (0, _eventEmiter2.default)(t);\n        }, i);\n      });\n\n      // PC 마우스 이벤트\n      c.addEventListener('mousedown', _eventEmiter2.default);\n      c.addEventListener('mouseup', _eventEmiter2.default);\n      c.addEventListener('mousemove', function (e) {\n        _this.suppressJob.setSuppress('mousemoveEvent', function () {\n          (0, _eventEmiter2.default)(e);\n        }, i);\n      });\n\n      c.addEventListener('click', _eventEmiter2.default);\n      c.addEventListener('dblclick', _eventEmiter2.default);\n      c.addEventListener('contextmenu', _eventEmiter2.default);\n\n      _this.cache.inited = true;\n    }\n  });\n\n  return this.lve;\n\n  // fullscreen orientation\n  // window.addEventListener('orientationchange', () => {\n  //   const screenElement = lve.root.cache.screenElement;\n  //   if (lve.root.cache.destroy) return;\n  //   if (screenElement === null) return;\n  //   if (screenElement.getAttribute('data-fullscreen-extend') === 'true') {\n  //     const screenScale = [\n  //       window.screen.width / screenElement.width,\n  //       window.screen.height / screenElement.height\n  //     ].sort((a, b) => {\n  //       return a - b\n  //     })[0];\n  //     screenElement.style.transform = 'scale(' + screenScale + ')';\n  //     lve.root.cache.screenScale = screenScale;\n  //   }\n  // });\n};\n\n//# sourceURL=webpack:///./src/LveJS/Functions/init.js?");
...
/***/ "./src/LveJS/Helpers/eventEmiter.js":
/*!******************************************!*\
  !*** ./src/LveJS/Helpers/eventEmiter.js ***!
  \******************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = eventEmiter;\nfunction eventEmiter(e) {\n\n  console.log(e);\n};\n\n//# sourceURL=webpack:///./src/LveJS/Helpers/eventEmiter.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _getProperties = __webpack_require__(/*! ./Utils/getProperties */ \"./src/LveJS/Utils/getProperties.js\");\n\nvar _getProperties2 = _interopRequireDefault(_getProperties);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction LveJSMouseEvent(e, c) {\n\n  var s1 = void 0,\n      s2 = void 0;\n  var r = void 0;\n\n  s1 = c.changedTouches ? c.changedTouches[0] : {};\n  s1 = _getProperties2.default.call(s1);\n  s2 = _getProperties2.default.call(c);\n\n  r = Object.assign({}, s1, s2);\n  r = new MouseEvent(e, r);\n\n  Object.defineProperties(r, {\n    target: {\n      value: c.target,\n      enumerable: true\n    },\n    which: {\n      value: c.which || 1,\n      enumerable: true\n    }\n  });\n\n  return r;\n}\n\nexports.default = LveJSMouseEvent;\n\n//# sourceURL=webpack:///./src/LveJS/LveJSMouseEvent.js?");
...
/***/ "./src/LveJS/Managers/Renderer/showEmptyFrame.js":
/*!*******************************************************!*\
  !*** ./src/LveJS/Managers/Renderer/showEmptyFrame.js ***!
  \*******************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = showEmptyFrame;\nfunction showEmptyFrame() {\n\n  var c = void 0;\n  var w = void 0,\n      h = void 0;\n\n  c = this.setting.canvas.context;\n\n  w = c.canvas.width;\n  h = c.canvas.height;\n\n  c.globalAlpha = 1;\n  c.fillStyle = 'black';\n\n  c.beginPath();\n  c.clearRect(0, 0, w, h);\n  c.fillRect(0, 0, w, h);\n\n  console.log(1);\n};\n\n//# sourceURL=webpack:///./src/LveJS/Managers/Renderer/showEmptyFrame.js?");
...
/***/ "./src/LveJS/Utils/getProperties.js":
/*!******************************************!*\
  !*** ./src/LveJS/Utils/getProperties.js ***!
  \******************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = getProperties;\nfunction getProperties() {\n\n  var r = void 0;\n\n  r = {};\n\n  for (var p in this) {\n    r[p] = this[p];\n  }\n\n  return r;\n};\n\n//# sourceURL=webpack:///./src/LveJS/Utils/getProperties.js?");
